        ...
        <div class="row">
            <div class="container">
                <div class="col-md-12">
                    ...
                    <form action="<?php echo e(route('event.store')); ?>" method="POST" id="event-form">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input class="form-control" value="<?php echo e(old('startDateTime')); ?>" type="date" name="startDateTime" id="startDateTime" required="required">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input class="form-control" value="<?php echo e(old('event_place')); ?>" type="text" name="event_place" id="event_place" required="required">
                            </div>
                        </div>
...
<?php echo $__env->make('alumni.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ams\ams\resources\views/alumni/event/create.blade.php ENDPATH**/ ?>