            ...
            <nav class="navbar navbar-expand-lg navbar-dark text-center">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav text-color">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-light" href="<?php echo e(url('peoples')); ?>">Registered People</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-light" href="<?php echo e(url('search')); ?>">Search</a>
                        </li>
                        <?php endif; ?>
                        <li class="nav-item">
...
<?php /**PATH C:\xampp\htdocs\ams\ams\resources\views/alumni/master.blade.php ENDPATH**/ ?>