        ...
        <div class="row">
            <div class="container">
                <div class="col-md-12">
                    ...
                    <form action="{{ route('notice.update',["id"=>$notice->id])}}" method="POST" id="notice-form">
                        @csrf
                        @method('patch')
                        <div class="form-group row">
                            <label for="title" class="col-2 col-form-label">Title <span class="text-danger">*</span></label>
                            <div class="col-10">
                                <input class="form-control" type="text" name="title" id="title" value="{{$notice->title}}" required="required" data-parsley-length="[3, 40]">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <textarea name="description" id="description" class="form-control" cols="10" rows="10">{{$notice->description}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <select id="department" name="department_id" class="form-control">
                                    ...
                                    <option value="{{$department->id}}" {{$notice->department_id == $department->id ? 'selected':''}}>{{$department->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
