                ...
                <div class="col-md-12">
                    ...
                    <form action="{{ route('event.store') }}" method="POST" id="event-form">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input class="form-control" value="{{old('startDateTime')}}" type="date" name="startDateTime" id="startDateTime" required="required">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input class="form-control" value="{{old('event_place')}}" type="text" name="event_place" id="event_place" required="required">
                            </div>
                        </div>
